...
// Recording requires a secure context (HTTPS or localhost). On plain
// http://<ip> we fall back to a file picker — on mobile this opens the
// device's native voice recorder, on desktop it accepts a pre-recorded
// audio file. Backend accepts webm/ogg/mp4/m4a/mpeg/wav/aac.
const CAN_RECORD_IN_BROWSER =
